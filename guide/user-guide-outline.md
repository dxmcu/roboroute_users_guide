...
在一个仙知规划的整场自动化方案中，RoboRoute 系统的定位如下图所示。RoboRoute 接受 MES、WMS 或者手持终端等设备的业务请求，同时以之为基础，规划、控制机器人的路线和行为，并最终完成业务目标。

![img](../pictures/01/system.png)
...
业务订单的组成结构，请参照 11.6 节的链接中，Transport Order 结构，以及 Transport Order State 结构的具体内容；或者参照 5.4.9 节中的业务订单详细信息。
...
| UNROUTEABLE     | RoboRoute 无法规划出合适的机器人来执行此业务。出现此状态时，请检查场景拓扑结构。 |
...
每个订单子任务，都由一个 “目的地” 和一个 “机器人在目的地要执行的操作” 构成。订单子任务描述了一个希望机器人 ”去哪儿，做什么“ 的数据结构。“目的地” 可以是工作站或节点；“操作” 可以为空，表现为字符串 “NOP”。一个业务订单，可以有一个至多个订单子任务。
